...
n lines follow with three integers on each separated by single spaces  ,  and  which are length, width and height in feet of the -th box.
...
int get_volume(box b) {
	...
	*/
    int result=0;
    result=b.length * b.width * b.height;
    return result;
